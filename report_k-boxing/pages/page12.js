function Spage12 () {
    ...
    this.html = '<div class="swiper-slide">' +
        ...
        '<div class="img-box d">' +
        '<img src="images/spe12/bg.jpeg" class="">' +
        '<div class="chartBox" id="graph-adults" style="width:60%;height:56%;top:28%;"></div>'+
...
Spage12.prototype.currentPageAction = function () {
    var _this = this;
    if (_this.rendered) return;
    $('#graph-adults').next('.sk-spinner').show();
    let myChart = echarts.init(document.getElementById('graph-adults'));
    var webkitDep
    $.ajax({
        url: 'json/data.json',
        success: function (d) {
            ...
            myChart.on('rendered', function () {
                _this.rendered = true;
                $('#graph-adults').next('.sk-spinner').hide();
