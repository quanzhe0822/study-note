function Spage4() {
    ...
    this.html = '<div class="swiper-slide">' +
        ...
        '<div class="img-box d">' +
        '<img src="images/spe4/bg.jpeg" class="">' +
        '<div class="chartBox" id="graph-civil-servent" style="width:60%;height:56%;top:28%;"></div>'+
...
Spage4.prototype.currentPageAction = function () {
    var _this = this;
    if (_this.rendered) return;
    $('#graph-civil-servent').next('.sk-spinner').show();
    let myChart = echarts.init(document.getElementById('graph-civil-servent'));
    var webkitDep
    $.ajax({
        url: 'json/data.json',
        success: function (d) {
            ...
            myChart.on('rendered', function () {
                _this.rendered = true;
                $('#graph-civil-servent').next('.sk-spinner').hide();
